            ...
            <div class="col-md-3"><!--SIDEBAR NAVIGATION -->
                ...
                if($pages->num_rows > 0){
                    ...
                    while($page =  $pages->fetch_assoc()){
                        ?>
                        <?php
                       echo "<a href='index.php?id=1&pageId=$page[id]' class='list-group-item'>$page[title]</a>";
                    }
                }
                ...
                <form action="<?php  htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                    ...
                    <div class="form-group"><label for="user">User</label>
                        <select name="user" id="user" class="form-control">
                            <option value="0" class="form-control">No user</option>
                            <?php
                                if(isset($_GET['id'])){
                                        echo "<option value='$_GET[id]' class='form-control'>$page[title]</option>";
                                }
                            ?>
                        </select>
